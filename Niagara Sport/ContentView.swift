            ...
            Button {
                ...
                ZStack {
                    ...
                    Image("tab 1")
                        ...
                        .offset(y: 3)
                        .foregroundColor(selectedTab == .home ? .hex("0C260B"): .white)
                }
            }
            ...
            Button {
                ...
                ZStack {
                    ...
                    Image("tab 2")
                        .renderingMode(.template)
                        .offset(y: 3)
                        .foregroundColor(selectedTab == .profile ? .hex("0C260B"): .white)
            ...
            Button {
                ...
                ZStack {
                    ...
                    Image("tab 3")
                        .renderingMode(.template)
                        .offset(y: 3)
                        .foregroundColor(selectedTab == .quotes ? .hex("0C260B"): .white)
            ...
            Button {
                ...
                ZStack {
                    ...
                    Image("tab 4")
                        .renderingMode(.template)
                        .offset(y: 3)
                        .foregroundColor(selectedTab == .stretch ? .hex("0C260B"): .white)
                }
            }
        }
        .padding(6)
        .padding(.horizontal, 20)
        .background(Color.hex("0C260B"))
        .cornerRadius(55)
        .padding(.bottom)
    }
}
